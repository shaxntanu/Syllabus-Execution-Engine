  ...
  return (
    <>
      ...
      <div className="bg-gray-800/50 backdrop-blur rounded-3xl p-10 border border-gray-700">
        <h3 className="text-xl font-bold text-white mb-8">💾 Backup & Restore</h3>
        ...
        <div className="space-y-8">
          ...
          <div>
            <label className="block text-sm text-gray-400 mb-4">Import Backup</label>
            <textarea
              value={importText}
              ...
              className="w-full bg-gray-700 text-gray-200 rounded-xl p-5 border border-gray-600 focus:border-blue-500 focus:outline-none font-mono text-sm"
              rows={5}
            />
          </div>
          ...
          <button
            ...
            disabled={!importText}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-medium py-4 rounded-xl transition-colors"
          >
            Import Backup
          </button>
        </div>
