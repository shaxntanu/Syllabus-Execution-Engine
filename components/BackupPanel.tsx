  ...
  return (
    <>
      ...
      <div className="bg-gray-800/50 backdrop-blur rounded-3xl p-12 border border-gray-700">
        <h3 className="text-xl font-bold text-white mb-10">💾 Backup & Restore</h3>

        <div className="space-y-10">
          <button
            onClick={generateBackup}
            className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-5 rounded-2xl transition-colors text-lg"
          >
            Generate Backup Code
          </button>

          <div>
            <label className="block text-sm text-gray-400 mb-6">Import Backup</label>
            <textarea
              value={importText}
              ...
              className="w-full bg-gray-700 text-gray-200 rounded-2xl p-6 border border-gray-600 focus:border-blue-500 focus:outline-none font-mono text-sm"
              rows={6}
            />
          </div>
          ...
          <button
            ...
            disabled={!importText}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-medium py-5 rounded-2xl transition-colors text-lg"
          >
            Import Backup
          </button>
        </div>
